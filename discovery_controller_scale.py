...
#from lib.templates.storage.storage_operations_template \import StorageControllerOperationsTemplate, HostsState
from lib.templates.storage.storage_operations_template import StorageControllerOperationsTemplate, HostsState
from lib.system.fun_test import *
...
class BringupSetup(FunTestScript):
    ...
    def __init__(self):
        super(BringupSetup, self).__init__()
        self.hosts = None
        self.fs_obj_list = None
        self.blt_template = None
    ...
    def CreateVolAttachToHost(self, num_vol, host_handle):
        ...
        self.capacity = 160027797094
        compression_effort = 0
        self.encrypt = False
        self.blt_count = self.num_vol
        #host_obj = self.topology.get_available_host_instances()
        #host_handle = host_obj.get_instance()
...
#             for host_obj in self.topology.get_available_host_instances():
#                 host_handle = host_obj.get_instance()
#                 BringupSetup.CreateVolAttachToHost(10, host_handle)
#             # def 10_volumes_host1:
#
#             ##super(ConnectAllContinuous, self).run()
#
#         def cleanup(self):
